...
// netlify/functions/absence-management.js
...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (event.httpMethod === "POST") {
      ...
      let finalPenalty = penaltyAmount !== void 0 ? penaltyAmount : 0;
      if (!isExcused && finalPenalty === 0 && absenceType === "no_show") {
        finalPenalty = dailyWage;
      }
...
//# sourceMappingURL=absence-management.js.map
