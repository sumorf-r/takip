...
// netlify/functions/advance-manage.js
    ...
    if (event.httpMethod === "GET") {
      ...
      result.rows.forEach((row) => {
        ...
        if (row.deduction_status === "pending")
          stats.pending_deduction += parseFloat(row.amount || 0);
      });
      return {
        statusCode: 200,
        headers,
          ...
          await client.query(
            `UPDATE advance_payments 
             SET status = 'paid',
                 ...
                 payment_method = $2
             WHERE id = $3`,
            [paymentDate || /* @__PURE__ */ new Date(), paymentMethod || "bank_transfer", advanceId]
          );
          await client.query(
            `INSERT INTO audit_logs (user_id, action, table_name, record_id)
             VALUES ($1, $2, $3, $4)`,
...
//# sourceMappingURL=advance-manage.js.map
