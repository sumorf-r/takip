...
// netlify/functions/approve-adjustment.js
  ...
  try {
    ...
    if (action !== "approve" && action !== "reject") {
      return {
        ...
        body: JSON.stringify({
          success: false,
          error: "Ge\xE7ersiz aksiyon (approve/reject)"
        })
      };
    }
    ...
    if (adjustmentResult.rows.length === 0) {
      return {
        ...
        body: JSON.stringify({
          success: false,
          error: "D\xFCzeltme kayd\u0131 bulunamad\u0131"
        })
      };
    }
    ...
    if (adjustment.status !== "pending") {
      return {
        ...
        body: JSON.stringify({
          success: false,
          error: "Bu d\xFCzeltme zaten i\u015Flenmi\u015F"
        })
      };
    }
    ...
    try {
      ...
      return {
        ...
        body: JSON.stringify({
          success: true,
          message: action === "approve" ? "D\xFCzeltme onayland\u0131" : "D\xFCzeltme reddedildi"
        })
      };
    } catch (error) {
...
//# sourceMappingURL=approve-adjustment.js.map
