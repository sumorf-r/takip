...
// netlify/functions/db-attendance-check-v2.js
var db_attendance_check_v2_exports = {};
__export(db_attendance_check_v2_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(db_attendance_check_v2_exports);
  ...
  try {
    ...
    try {
      ...
      if (locationQuery.rows.length === 0) {
        throw new Error("Ge\xE7ersiz lokasyon");
      }
      ...
      if (action === "check-out" && hasOpenAttendance) {
        ...
        workHours = (checkOutTime - checkInTime) / (1e3 * 60 * 60);
        if (workHours < 8) {
          const remainingHours = 8 - workHours;
          earlyLeaveWarning = `\u26A0\uFE0F Standart mesai s\xFCresini (8 saat) doldurmad\u0131n\u0131z. Kalan: ${remainingHours.toFixed(1)} saat. Erken \xE7\u0131k\u0131\u015F cezas\u0131 uygulanacakt\u0131r.`;
        }
        ...
        if (earlyLeaveWarning) {
          await client.query(
            ...
            [personnelId, "Erken \xC7\u0131k\u0131\u015F Uyar\u0131s\u0131", earlyLeaveWarning]
          );
        }
        await client.query(
        ...
        throw new Error(
          action === "check-in" && hasOpenAttendance ? "Zaten a\xE7\u0131k bir giri\u015F kayd\u0131n\u0131z var" : "A\xE7\u0131k giri\u015F kayd\u0131n\u0131z bulunmuyor"
        );
      }
      ...
      await client.query(
        ...
        [
          personnelId,
          hasOpenAttendance ? "\xC7\u0131k\u0131\u015F Yap\u0131ld\u0131" : "Giri\u015F Yap\u0131ld\u0131",
          hasOpenAttendance ? `\xC7\u0131k\u0131\u015F saatiniz: ${(/* @__PURE__ */ new Date()).toLocaleTimeString("tr-TR")}` : `Giri\u015F saatiniz: ${(/* @__PURE__ */ new Date()).toLocaleTimeString("tr-TR")}`
        ]
      );
...
//# sourceMappingURL=db-attendance-check-v2.js.map
