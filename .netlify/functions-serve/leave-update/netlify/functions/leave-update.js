...
// netlify/functions/leave-update.js
...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (!personnelId || monthlyLeaveDays === void 0) {
      return {
        statusCode: 400,
        headers,
        body: JSON.stringify({
          success: false,
          error: "Personnel ID ve ayl\u0131k izin g\xFCn\xFC gerekli"
        })
      };
    }
    ...
    const result = await client.query(updateQuery, [
      monthlyLeaveDays,
      remainingLeaveDays !== void 0 ? remainingLeaveDays : null,
      personnelId
    ]);
    ...
    return {
      ...
      body: JSON.stringify({
        success: true,
        message: "\u0130zin hakk\u0131 g\xFCncellendi",
    ...
    return {
      ...
      body: JSON.stringify({
        success: false,
        error: error.message || "\u0130zin g\xFCncellenirken hata olu\u015Ftu"
      })
    };
  } finally {
    await client.end();
...
//# sourceMappingURL=leave-update.js.map
