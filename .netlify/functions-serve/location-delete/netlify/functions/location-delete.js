...
// netlify/functions/location-delete.js
var location_delete_exports = {};
__export(location_delete_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(location_delete_exports);
    ...
    try {
      ...
      if (parseInt(personnelCheck.rows[0].count) > 0) {
        ...
        return {
          ...
          body: JSON.stringify({
            success: false,
            error: "Bu lokasyona ba\u011Fl\u0131 aktif personel var. \xD6nce personelleri ba\u015Fka lokasyona ta\u015F\u0131y\u0131n."
          })
        };
      }
...
//# sourceMappingURL=location-delete.js.map
