...
// netlify/functions/location-update.js
var location_update_exports = {};
__export(location_update_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(location_update_exports);
    ...
    try {
      ...
      return {
        ...
        body: JSON.stringify({
          ...
          message: "Lokasyon g\xFCncellendi"
        })
      };
    } catch (error) {
      client.release();
...
//# sourceMappingURL=location-update.js.map
