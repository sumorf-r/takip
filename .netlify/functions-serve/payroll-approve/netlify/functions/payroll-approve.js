...
// netlify/functions/payroll-approve.js
...
exports.handler = async (event) => {
  ...
  try {
    ...
    try {
      switch (action) {
        ...
        case "pay":
          if (payroll.status === "approved") {
            ...
            actionMessage = "Bordro \xF6dendi ve avanslar kapat\u0131ld\u0131";
          } else {
            throw new Error("Sadece onaylanm\u0131\u015F bordrolar \xF6denebilir");
          }
          break;
        case "cancel":
          newStatus = "cancelled";
          ...
          break;
        default:
          throw new Error("Ge\xE7ersiz aksiyon");
      }
      let updateQuery = `
        UPDATE payroll 
      ...
      if (action === "pay") {
        updateParams.push(paymentStatus, paymentDate || /* @__PURE__ */ new Date(), paymentMethod || "bank_transfer");
      }
      if (action === "cancel") {
      ...
      if (action === "pay") {
        finalParams.push(paymentStatus, paymentDate || /* @__PURE__ */ new Date(), paymentMethod || "bank_transfer");
      } else if (action === "cancel") {
      ...
      await client.query(
        ...
        action === "pay" ? [newStatus, approvedBy, paymentStatus, paymentDate || /* @__PURE__ */ new Date(), paymentMethod || "bank_transfer", payrollId] : action === "cancel" ? [newStatus, approvedBy, notes || "\u0130ptal edildi", payrollId] : [newStatus, approvedBy, payrollId]
      );
      await client.query(
...
//# sourceMappingURL=payroll-approve.js.map
