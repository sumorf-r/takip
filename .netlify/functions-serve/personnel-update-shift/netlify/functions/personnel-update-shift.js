...
// netlify/functions/personnel-update-shift.js
var personnel_update_shift_exports = {};
__export(personnel_update_shift_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(personnel_update_shift_exports);
    ...
    try {
      ...
      return {
        ...
        body: JSON.stringify({
          success: true,
          personnel,
          message: "Mesai ayarlar\u0131 ba\u015Far\u0131yla g\xFCncellendi"
        })
      };
    } catch (error) {
      client.release();
...
//# sourceMappingURL=personnel-update-shift.js.map
