...
// netlify/functions/personnel-update.js
var personnel_update_exports = {};
__export(personnel_update_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(personnel_update_exports);
    ...
    try {
      ...
      return {
        ...
        body: JSON.stringify({
          ...
          message: "Personel bilgileri g\xFCncellendi"
        })
      };
    } catch (error) {
      client.release();
...
//# sourceMappingURL=personnel-update.js.map
