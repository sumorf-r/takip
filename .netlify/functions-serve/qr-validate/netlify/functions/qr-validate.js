...
// netlify/functions/qr-validate.js
...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (new Date(tokenData.expires_at) < /* @__PURE__ */ new Date()) {
      return {
        statusCode: 401,
        headers,
        body: JSON.stringify({
          success: false,
          error: "QR kod s\xFCresi dolmu\u015F. Yeni QR kod taray\u0131n.",
          code: "TOKEN_EXPIRED"
        })
      };
    }
    ...
    const locationCode = locationResult.rows.length > 0 ? locationResult.rows[0].location_code : tokenData.location_id;
    return {
      statusCode: 200,
      headers,
      body: JSON.stringify({
        ...
        // Frontend için location_code döndür
        token
      })
    };
  } catch (error) {
...
//# sourceMappingURL=qr-validate.js.map
