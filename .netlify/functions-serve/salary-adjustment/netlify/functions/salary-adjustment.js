...
// netlify/functions/salary-adjustment.js
  ...
  try {
    ...
    if (!personnelId || !adjustmentType || !amount || !reason || !createdBy) {
      return {
        ...
        body: JSON.stringify({
          success: false,
          error: "T\xFCm alanlar zorunludur"
        })
      };
    }
    ...
    if (!validTypes.includes(adjustmentType)) {
      return {
        ...
        body: JSON.stringify({
          success: false,
          error: "Ge\xE7ersiz d\xFCzeltme tipi"
        })
      };
    }
    ...
    return {
      ...
      body: JSON.stringify({
        success: true,
        message: autoApprove ? "D\xFCzeltme uyguland\u0131" : "D\xFCzeltme onay bekliyor",
    ...
    return {
      ...
      body: JSON.stringify({
        success: false,
        error: error.message || "D\xFCzeltme i\u015Flemi ba\u015Far\u0131s\u0131z"
      })
    };
  } finally {
    await client.end();
...
//# sourceMappingURL=salary-adjustment.js.map
